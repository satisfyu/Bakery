...
import net.satisfy.bakery.block.cakes.CakeBlock;
import net.satisfy.bakery.block.cakes.*;
import net.satisfy.bakery.block.crops.OatCropBlock;
import net.satisfy.bakery.block.crops.StrawberryCropBlock;
import net.satisfy.bakery.block.storage.CabinetWallBlock;
import net.satisfy.bakery.block.storage.*;
import net.satisfy.bakery.item.BakeryStandardItem;
import net.satisfy.bakery.item.CookingPotItem;
import net.satisfy.bakery.item.EffectItem;
import net.satisfy.bakery.item.FoodBlockItem;
...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> WILD_STRAWBERRIES = registerWithItem("wild_strawberries", () -> new TallGrassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).replaceable().noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XYZ).ignitedByLava().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistrySupplier<Block> KITCHEN_SINK = registerWithItem("kitchen_sink", () -> new SinkBlock(BlockBehaviour.Properties.copy(Blocks.BRICKS).noOcclusion().pushReaction(PushReaction.IGNORE)));
    ...
    public static final RegistrySupplier<Block> BUN_BLOCK = registerWithoutItem("bun_block", () -> new StackableEatableBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), 4));
    ...
    public static final RegistrySupplier<Block> STRAWBERRY_CAKE = registerWithItem("strawberry_cake", () -> new net.satisfy.bakery.block.cakes.CakeBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), ObjectRegistry.STRAWBERRY_CAKE_SLICE));
    public static final RegistrySupplier<Block> SWEETBERRY_CAKE = registerWithItem("sweetberry_cake", () -> new net.satisfy.bakery.block.cakes.CakeBlock((BlockBehaviour.Properties.copy(Blocks.CAKE)), ObjectRegistry.SWEETBERRY_CAKE_SLICE));
    public static final RegistrySupplier<Block> CHOCOLATE_CAKE = registerWithItem("chocolate_cake", () -> new net.satisfy.bakery.block.cakes.CakeBlock((BlockBehaviour.Properties.copy(Blocks.CAKE)), ObjectRegistry.CHOCOLATE_CAKE_SLICE));
