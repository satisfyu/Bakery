...
public class ChocolateTartBlock extends PieBlock {
    public ChocolateTartBlock(Properties settings, Supplier<Item> slice) {
    ...
    public static VoxelShape makeShape() {
        ...
        shape = Shapes.or(shape, Shapes.box(0.1875, 0, 0.1875, 0.8125, 0.25, 0.8125));
        return shape;
    }
    ...
    public static VoxelShape makeShape1() {
        VoxelShape shape = Shapes.empty();
        shape = Shapes.or(shape, Shapes.box(0.1875, 0, 0.5, 0.5, 0.25, 0.8125));
        return shape;
    }
