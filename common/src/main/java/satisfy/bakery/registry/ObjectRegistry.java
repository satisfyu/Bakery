...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> SMALL_COOKING_POT_ITEM = registerItem("small_cooking_pot", () -> new BlockItem(SMALL_COOKING_POT.get(), getSettings()));
    ...
    public static final RegistrySupplier<Item> CROISSANT = registerItem("croissant", () -> new EffectItem(getFoodItemSettings(5, 0.6f, MobEffectRegistry.SUSTENANCE.get(), 60 * 15), 400));
    ...
    public static final RegistrySupplier<Item> VEGETABLE_SANDWICH = registerItem("vegetable_sandwich", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SUSTENANCE.get(), 60 * 15), 4800));
    public static final RegistrySupplier<Item> SANDWICH = registerItem("sandwich", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SUSTENANCE.get(), 60 * 15), 6000));
    public static final RegistrySupplier<Item> STRAWBERRY_CAKE_SLICE = registerItem("strawberry_cake_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 700));
    public static final RegistrySupplier<Item> SWEETBERRY_CAKE_SLICE = registerItem("sweetberry_cake_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 700));
    public static final RegistrySupplier<Item> CHOCOLATE_CAKE_SLICE = registerItem("chocolate_cake_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 700));
    public static final RegistrySupplier<Item> CHOCOLATE_GATEAU_SLICE = registerItem("chocolate_gateau_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> BUNDT_CAKE_SLICE = registerItem("bundt_cake_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> LINZER_TART_SLICE = registerItem("linzer_tart_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> APPLE_PIE_SLICE = registerItem("apple_pie_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> GLOWBERRY_PIE_SLICE = registerItem("glowberry_pie_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> CHOCOLATE_TART_SLICE = registerItem("chocolate_tart_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    ...
    public static final RegistrySupplier<Item> PUDDING_SLICE = registerItem("pudding_slice", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    ...
    public static final RegistrySupplier<Item> STRAWBERRY_GLAZED_COOKIE = registerItem("strawberry_glazed_cookie", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> SWEETBERRY_GLAZED_COOKIE = registerItem("sweetberry_glazed_cookie", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> CHOCOLATE_GLAZED_COOKIE = registerItem("chocolate_glazed_cookie", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> STRAWBERRY_CUPCAKE = registerItem("strawberry_cupcake", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> SWEETBERRY_CUPCAKE = registerItem("sweetberry_cupcake", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> APPLE_CUPCAKE = registerItem("apple_cupcake", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> CORNET = registerItem("cornet", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    public static final RegistrySupplier<Item> JAM_ROLL = registerItem("jam_roll", () -> new EffectItem(getFoodItemSettings(3, 0.5f, MobEffectRegistry.SWEETS.get(), 60 * 15), 800));
    ...
    public static final RegistrySupplier<Item> CHOCOLATE_TRUFFLE = registerItem("chocolate_truffle", () -> new EffectItem(getFoodItemSettings(2, 0.4f, MobEffectRegistry.SWEETS.get(), 60 * 15), 200));
    public static final RegistrySupplier<Item> MISSLILITU_BISCUIT = registerItem("misslilitu_biscuit", () -> new EffectItem(getFoodItemSettings(6, 0.6f, MobEffectRegistry.SUSTENANCE.get(), 60 * 15), 4200));
