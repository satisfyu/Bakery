...
import satisfyu.bakery.client.gui.recipebook.PrivateRecipeBookRecipeArea;
...
public abstract class  PrivateRecipeBookWidget extends GuiComponent implements PlaceRecipe<Ingredient>, Widget, GuiEventListener, RecipeShownListener {
    ...
    protected void setOpen(boolean opened) {
        ...
        this.open = opened;
        BakeryClient.rememberedRecipeBookOpen = opened;
        if (!opened) {
    ...
    private boolean isGuiOpen() {
        return BakeryClient.rememberedRecipeBookOpen;
    }
    ...
    private boolean toggleFilteringCraftable() {
        boolean bl = !BakeryClient.rememberedCraftableToggle;
        BakeryClient.rememberedCraftableToggle = bl;
        return bl;
    }
    ...
    private void refreshResults(boolean resetCurrentPage) {
        ...
        if (BakeryClient.rememberedCraftableToggle) {
    ...
    public void reset() {
        ...
        this.toggleCraftableButton = new StateSwitchingButton(i + 110, j + 12, 26, 16, BakeryClient.rememberedCraftableToggle);
