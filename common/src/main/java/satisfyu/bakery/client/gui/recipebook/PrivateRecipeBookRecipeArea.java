...
public class PrivateRecipeBookRecipeArea {
    ...
    private AbstractPrivateRecipeScreenHandler CookingPotGuiHandler;
    ...
    public void initialize(Minecraft client, int parentLeft, int parentTop, AbstractPrivateRecipeScreenHandler cookingPotGuiHandler) {
        this.client = client;
        this.CookingPotGuiHandler = cookingPotGuiHandler;
    ...
    private void refreshResultButtons() {
        ...
        for(int j = 0; j < this.resultButtons.size(); ++j) {
            ...
            if (i + j < this.resultCollections.size()) {
                ...
                animatedResultButton.showResultCollection(recipe, CookingPotGuiHandler);
